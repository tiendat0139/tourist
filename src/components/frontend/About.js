...
import styles from "~/assets/css/component/frontend/About.module.scss";
...
const About = function () {
  ...
  return (
    <div className={cx("about")}>
      ...
      >
        <h1 className={cx("header")} style={{ opacity: `${1 - offset / 400}` }}>
          About Us
        </h1>
      </div>
            ...
            <div className={cx("content", "col-6")}>
              <div className={cx("navbar", "row")}>
                <div className={cx("col-4")}>
                  <div
                    className={cx("navbar-item", { active: showDesc[1] })}
                    ctid="1"
                    onClick={(e) => handleShowDesc(e)}
                  >
                    What we do
                  </div>
                </div>
                <div className={cx("col-4")}>
                  <div
                    className={cx("navbar-item", { active: showDesc[2] })}
                    ctid="2"
                    onClick={(e) => handleShowDesc(e)}
                  >
                    Our mission
                ...
                <div className={cx("col-4")}>
                  <div
                    className={cx("navbar-item", { active: showDesc[3] })}
                    ctid="3"
                    onClick={(e) => handleShowDesc(e)}
                  >
                    Our goal
              ...
              <div className={cx("desc", { "active-desc": showDesc[1] })}>
                ...
                We always try to cooperate with hotels and tourist attractions
                to create tours at the most reasonable prices. What's more,
                we're looking for the best collaborators to help you travel. We
                always strive to bring you the best experience in Vietnam.
              </div>
              <div className={cx("desc", { "active-desc": showDesc[2] })}>
                <h2 className="mb-4">Exceptional Web Solutions</h2>
                We always wanted to create a website that makes it easier for
                foreigners to travel in Vietnam. Moreover, the company always
                tries to create a large number of collaborators to guide
                visitors
              </div>
              <div className={cx("desc", { "active-desc": showDesc[3] })}>
                <h2 className="mb-4">Help Our Customer</h2>
                Currently, the company has 50,000 users and 1000 active
                collaborators at tourist destinations across Vietnam.
              </div>
            </div>
          </div>
        </div>
              ...
              <div className={cx("col-md-6")}>
                <div className={cx("item")}>
                  ...
                  <i
                    ...
                    opid="1"
                    onClick={(e) => handleOpenAws(e)}
                  ></i>
                  <i
                    className={cx("fa-solid fa-circle-minus", {
                      "show-icon": openAws[1],
                    })}
                    opid="1"
                    onClick={(e) => handleOpenAws(e)}
